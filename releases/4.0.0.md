...
- Fixed: guard against undefined `settings.actions` in connections components
- Improved: aligned breadcrumb display separator across display names and list headers
