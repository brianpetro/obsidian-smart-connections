...
- move `exclude_blocks_from_source` setting implementation into `find_connections` method instead of relying on passing parameters (respects setting across implementations)